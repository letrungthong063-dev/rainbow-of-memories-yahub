          ...
          <table className="w-full text-sm">
            <thead className="bg-[#f5f4f0] border-b border-[#d8dcdf]">
              <tr>
                ...
                <th className="text-left px-4 py-3 font-bold text-[#67747e] text-xs uppercase hidden md:table-cell">Đăng nhập gần nhất</th>
            ...
            <tbody className="divide-y divide-[#f0f0f0]">
              {users.map(user => (
                <tr key={user.id} className="hover:bg-[#fafafa] transition-colors">
                  ...
                  <td className="px-4 py-3 text-[#67747e] hidden md:table-cell text-xs">
